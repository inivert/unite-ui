/**
 * Type definitions for uniteImageParticles
 */

/**
 * Options for initializing the UniteImageParticle class.
 */
interface UniteImageParticleOptions {
  width?: number;
  height?: number;
  maxWidth?: number;
  maxHeight?: number;
...
/**
 * UniteImageParticle class for creating particle animations from images.
 */
export declare class UniteImageParticle implements EventHandlers {
  constructor(options?: UniteImageParticleOptions);
  ...
  start(options?: Partial<UniteImageParticleOptions>): void;
  stop(options?: Partial<UniteImageParticleOptions>): void;

  // Private Methods
  private _animate(): void;
  private _onImageLoaded(options: UniteImageParticleOptions): void;
  private _initImage(options: UniteImageParticleOptions): void;
  private _initContext(options: UniteImageParticleOptions): void;
  private _defaultInitContext(options: UniteImageParticleOptions): void;
...
/**
 * Initializes the UniteImageParticle module and returns the class.
 */
export declare const uniteImageParticles: () => {
  UniteImageParticle: typeof UniteImageParticle;
};
